...
public class TipoAsignaturaController implements Serializable {
    ...
    public String create() {
        try {
            ...
            facesContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "TipoAsignatura creado", "Se ha creado una correctamente"));
    ...
    public String update() {
        try {
            ...
            FacesContext facesContext = FacesContext.getCurrentInstance();
            facesContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "TipoAsignatura actualizado", "Se ha actualizado correctamente"));
            return "View";
        } catch (Exception e) {
            FacesContext facesContext = FacesContext.getCurrentInstance();
    ...
    private void performDestroy() {
        try {
            ...
            FacesContext facesContext = FacesContext.getCurrentInstance();
            facesContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "TipoAsignatura eliminado", "Se ha eliminado una {entityClassName}"));
        } catch (Exception e) {
            FacesContext facesContext = FacesContext.getCurrentInstance();
