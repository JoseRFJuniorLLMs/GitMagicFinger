...
@NamedQueries({
    ...
    @NamedQuery(name = "Asistencia.CountAsistenciaBloqueAndFecha", query = "SELECT a FROM Asistencia a WHERE (a.estado = 1 OR a.estado = 3) AND a.bloIdBloque = :Bloque AND a.fecha =:Fecha"),
